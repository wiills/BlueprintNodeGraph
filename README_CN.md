...
BlueprintNodeGraph 是专为 UE5 设计的 **蓝图原生异步流程框架**，替代零散延迟/等待节点、简化任务/剧情/关卡逻辑开发，**支撑上线项目全关卡逻辑验证**。

核心优势：**标准蓝图内直接使用、原生并行异步、GC 安全、网络同步、低开销易扩展**。
...
**核心文件：**
- [ExBase_LatentTask.h](Source/BlueprintNodeGraph/Public/BlueprintTool/LatentTasks/ExBase_LatentTask.h) - 延迟任务基类
- [ExLatentActionManager.h](Source/BlueprintNodeGraph/Public/BlueprintTool/Subsystems/ExLatentActionManager.h) - 代理管理器
- [ExK2Node_LatentTaskCall.h](Source/BlueprintNodeGraphEditor/Public/BlueprintTool/K2Nodes/ExK2Node_LatentTaskCall.h) - K2 节点扩展
...
**文件位置：** [ExLatentProxyDefine.h](Source/BlueprintNodeGraph/Public/BlueprintTool/Common/ExLatentProxyDefine.h)
...
**文件位置：** [ExBase_AsyncAction.h](Source/BlueprintNodeGraph/Public/BlueprintTool/AsyncActions/ExBase_AsyncAction.h)
...
**文件位置：** [ExLatentNodeInfo](Source/BlueprintNodeGraph/Public/BlueprintTool/Common/ExLatentProxyDefine.h)
...
**文件位置：** [ExBase_LatentTask.h](Source/BlueprintNodeGraph/Public/BlueprintTool/LatentTasks/ExBase_LatentTask.h)
...
就这么简单！查看 [快速开始指南](Docs/Usage.md) 了解更多。
...
- [故障排除](Docs/Usage.md) - 常见问题的解决方案
- [最佳实践](Docs/Usage.md) - 使用建议和技巧
