...
#include "ExBase_AsyncAction.generated.h"

class UGameInstance;

/**
 * @class UExBase_AsyncAction
...
class BLUEPRINTNODEGRAPH_API UExBase_AsyncAction : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UExBase_AsyncAction(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
 ...
 *
 * 继承自 UExBase_AsyncAction，添加了成功和失败两个委托，
 * 用于通知调用方操作的执行结果。
 */
UCLASS()
class BLUEPRINTNODEGRAPH_API UExAsyncActionProxy : public UExBase_AsyncAction
{
	GENERATED_BODY()
