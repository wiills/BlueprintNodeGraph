...
#include "ExAsyncStreamLevel.generated.h"
 ...
 */
UCLASS()
class BLUEPRINTNODEGRAPH_API UExAsyncStreamLevel : public UExAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UExAsyncStreamLevel* AsyncLoadLevel(
	...
	static UExAsyncStreamLevel* AsyncUnloadLevel(
		UObject* WorldContextObject,
		FName LevelName
	);
