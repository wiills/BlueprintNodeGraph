...
#include "ExProxy_LoopDelay.generated.h"
...
class BLUEPRINTNODEGRAPH_API UExProxy_LoopDelay : public UExBase_FlowProxy
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UE_DEPRECATED(4.26, "UExProxy_LoopDelay Node has been deprecated.  Use ExForLoopWithDelay instead")
	UFUNCTION(BlueprintCallable, Category="Utilities|FlowControl", meta=(WorldContext="WorldContextObject", HidePin="UUID"))
	static UExProxy_LoopDelay* CreateProxy(UObject* WorldContextObject, FString UUID, float Duration=2.f, bool bNeedFirstDelay=false);
