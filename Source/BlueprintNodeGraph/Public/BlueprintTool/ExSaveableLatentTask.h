...
#include "ExSaveGameTypes.h"
#include "ExSaveableLatentTask.generated.h"

/**
 * @class UExSaveableLatentTask
 * @brief 支持存档的延迟任务基类
 * 
 * 提供基础的存档和断点续跑能力。
...
class BLUEPRINTNODEGRAPH_API UExSaveableLatentTask : public UExLatentTaskBase
{
	GENERATED_BODY()
