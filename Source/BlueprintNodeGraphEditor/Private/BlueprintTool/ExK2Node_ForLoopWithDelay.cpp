...
#include "BlueprintTool/ExK2Node_ForLoopWithDelay.h"
...
{
	ProxyFactoryFunctionName = GET_FUNCTION_NAME_CHECKED(UExForLoopWithDelayProxy, CreateProxy);
	ProxyActivateFunctionName = GET_FUNCTION_NAME_CHECKED(UExForLoopWithDelayProxy, Activate);
	ProxySetK2NodeInfoFunctionName = GET_FUNCTION_NAME_CHECKED(UExForLoopWithDelayProxy, SetK2NodeInfo);
	ProxyFactoryClass = UExForLoopWithDelayProxy::StaticClass();
	ProxyClass = UExForLoopWithDelayProxy::StaticClass();
}
